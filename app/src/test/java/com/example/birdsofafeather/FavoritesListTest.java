...
public class FavoritesListTest {
    ...
    public void test_favoriteList() {
        ...
        scenario.onActivity(activity -> {
            // In setup 2 people were favorite classmates, (id = 2 and id = 3), 4 classmates in total

            // Check if only two people are in recyclerview in FavoriteListActivity
            ...
            // Check if correct classmates are favorites
            assertEquals("2", favoriteTestClassmates.get(0).getId());
            assertEquals("3", favoriteTestClassmates.get(1).getId());
        });
    }
}