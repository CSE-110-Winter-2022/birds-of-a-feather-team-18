    ...
    public void nameRenameSessionTest() {
        ...
        ViewInteraction editText2 = onView(
                allOf(childAtPosition(
                        ...
                        0),
                        isDisplayed()));
        editText2.perform(replaceText("Session 2"), closeSoftKeyboard());
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.session_row_name), withText("Session 2"),
                        withParent(withParent(withId(R.id.sessions_view))),
                        isDisplayed()));
        textView3.check(matches(withText("Session 2")));
    }
